        ...
        <div className="flex items-center justify-center min-h-screen p-8 bg-[linear-gradient(135deg,#667eea_0%,#764ba2_100%)]">
            <div className="max-w-[800px] text-center text-white">
                ...
                <div className="flex gap-4 justify-center flex-wrap">
                    <a href="#projects" className="px-8 py-3.5 rounded-lg no-underline font-semibold text-base transition-all duration-300 inline-block bg-white text-[#364AB0] hover:-translate-y-0.5 hover:shadow-[0_10px_25px_rgba(0,0,0,0.2)]">
                        Voir mes projets
                    </a>
                    <a href="#contact" className="px-8 py-3.5 rounded-lg no-underline font-semibold text-base transition-all duration-300 inline-block bg-transparent text-white border-2 border-white hover:bg-white hover:text-[#364AB0] hover:-translate-y-0.5">
                        Me contacter
                    </a>
                </div>
